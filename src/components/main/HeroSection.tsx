  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto h-full min-h-[550px] bg-img--hero-section text-black flex flex-col gap-4 justify-center pl-5">
      ...
      <div className="w-fit flex flex-col gap-1 md:gap-2">
        ...
        <h2 className="text-3xl md:text-[51px] text-fit-red font-bold">
          Eat Clean with Fit Mafia.
        </h2>
        <h5 className="text-2xl md:text-[35px] text-black font-semibold">
      ...
      <div className="w-fit max-w-1/2 flex flex-wrap gap-3 text-sm">
        ...
        <div className="w-fit h-10 px-4 flex gap-2 items-center rounded-lg border border-black text-grey-300 cursor-pionter">
          {/* <Star className='w-4 h-4' /> */}⭐ Choose Your Meal Preferences
        </div>
      </div>
